...
<html lang="en">
  ...
  <div class="header">
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
      <img src="../image/yfood_logo.png" alt="" class="styte_image" style="width: 100px;    background-image: none;">
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="oi oi-menu"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
          <li class="nav-item"><a href="dashboad.php" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="blog_single.php" class="nav-link">Blog</a></li>
	          <li class="nav-item active"><a href="contacts.php" class="nav-link">Contacts</a></li>
    ...
    <div class="hero-wrap hero-wrap-2" style="background-image: url(../image/am-thuc.jpg); background-size: cover; background-repeat: no-repeat;" data-stellar-background-ratio="0.2">
      <div class="overlay"></div>
      <div class="container-fluid">
        <div class="row no-gutters d-flex slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          	<p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.1 }"><span class="mr-2"><a href="index.html">Home</a></span> <span>Blog</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.1 }">Our Blog</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> 79 Đ. Hồ Tùng Mậu, Mai Dịch, Cầu Giấy, Hà Nội</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://123456789">+ 0123 4567 89</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:123@contact123.com">123@contact123.com</a></p>
          </div>
          <div class="col-md-3">
        ...
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form action="#">
              ...
              <div class="form-group">
                <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Vấn đề của bạn là gì"></textarea>
              </div>
              <div class="form-group">
